	...
	for experiment in experiments:
		for threshold in thresholds:
			...
			if multinet == True:
				...
				to_save = result_directory + file_name
				call_process = "java -Xms20g -Xmx20g -XX:-UseGCOverheadLimit attribute_selector_ranker " + str(split) + " " + disease + " " + experiment+ " " + data_type + " " + threshold + " > " + to_save  
