...
percentTopGenes = 50# percent of topTable genes
...
result_directory = paste("/scratch/vinnie/GEOPipelineFiles_ubuntu/results/", disease, "_binarize", "/", exp_split, "/", action, "/", split_type, "/", threshold_input, "/", sep = "")
