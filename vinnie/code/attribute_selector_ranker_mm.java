...
public class attribute_selector_ranker_mm{
...
*/
		...
		String data_directory = "/scratch/vinnie/GEOPipelineFiles_ubuntu/results_MM/"+disease+"_binarize/"+experiment+"/train/"+type+"/"+threshold+"/";
		String test_data_directory = "/scratch/vinnie/GEOPipelineFiles_ubuntu/results_MM/"+disease+"_binarize/"+experiment+"/test/"+type+"/"+threshold+"/";
...
*/
		...
		String data_file = "MM_" + disease + "_" + experiment+"_" + type + "_" +threshold+"_train.arff";
		String test_data_file = "MM_" + disease + "_" + experiment+"_" + type + "_" +threshold+"_test.arff";
...
*/
		String train_file_save = "/scratch/vinnie/multinet/multinet/attributes_testing_MM/"+disease+"_"+type+"/train/"+experiment+"_"+threshold+"_"+type+"_"+num_attr+"_attr_train.arff";	
		String test_file_save = "/scratch/vinnie/multinet/multinet/attributes_testing_MM/"+disease+"_"+type+"/test/"+experiment+"_"+threshold+"_"+type+"_"+num_attr+"_attr_test.arff";	
