...
def run_bayes_net(disease, data_type,multinet=False):
  ...
  result_directory = '/scratch/vinnie/multinet/multinet/attributes_testing_MM/' + disease + '_' + data_type + '/' 
	...
	for experiment in experiments:
		for threshold in thresholds:
			...
			if multinet == True:
				...
				to_save = result_directory + file_name
				call_process = "java attribute_selector_ranker_mm " + str(split) + " " + disease + " " + experiment+ " " + data_type + " " + threshold + " > " + to_save 
