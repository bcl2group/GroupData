...
public class FishersExactTest {
	 ...
	 * 
	 * @param a an entry in the table as described in {@link #FishersExactTest()}.
	 * @param b an entry in the table as described in {@link #FishersExactTest()}.
	 * @param c an entry in the table as described in {@link #FishersExactTest()}.
	 * @param d an entry in the table as described in {@link #FishersExactTest()}.
	 * @return the p-value.
	 */
