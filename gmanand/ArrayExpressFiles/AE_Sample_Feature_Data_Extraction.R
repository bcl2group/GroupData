...
#Access array txt file, extract number of features, for example...
mexp4<-read.table.url("http://www.ebi.ac.uk/arrayexpress/files/A-MEXP-1/A-MEXP-1.adf.txt",skip=15,sep=\t)
length(mexp4[,1])
##################################################################################
