...
yfiles.module("demo.yfiles.graph.tableeditor.style", function(exports) {
   ...
   */
  /*public*/ exports.ColumnInsetConverter = new yfiles.ClassDefinition(function() {
    return {
      ...
      'convert': function(/*yfiles.lang.Object*/ value, /*yfiles.lang.Object*/ parameter) {
        ...
        if (stripe !== null) {
          return new yworks.canvas.geometry.structs.InsetsD.FromLeftTopRightAndBottom(0, stripe.getActualInsets().$top, 0, stripe.getActualInsets().$bottom);
        }
