...
yfiles.module("demo.yfiles.graph.tableeditor.style", function(exports) {
   ...
   */
  /*public*/ exports.AlternatingLeafStripeStyle = new yfiles.ClassDefinition(function() {
    return {
      ...
      'createVisual': function(/*yworks.yfiles.ui.model.INode*/ node, /*yworks.canvas.drawing.IRenderContext*/ ctx) {
        ...
        if (stripe !== null) {
          ...
          var /*demo.yfiles.graph.tableeditor.style.AlternatingLeafStripeStyle.RenderDataCache*/ renderData = demo.yfiles.graph.tableeditor.style.AlternatingLeafStripeStyle.createRenderDataCache(ctx, descriptor, stripe, stripeInsets.clone());
      ...
      'updateVisual': function(/*yworks.yfiles.ui.model.INode*/ node, /*yworks.canvas.drawing.IRenderContext*/ ctx, /*yworks.canvas.CanvasContainer*/ oldVisual) {
        ...
        if (stripe !== null) {
          ...
          var /*demo.yfiles.graph.tableeditor.style.AlternatingLeafStripeStyle.RenderDataCache*/ oldCache = yworks.canvas.svg.SVGExtensions.getRenderDataCache(demo.yfiles.graph.tableeditor.style.AlternatingLeafStripeStyle.RenderDataCache.$class, oldVisual);
          // get the data for the new visual
          var /*demo.yfiles.graph.tableeditor.style.AlternatingLeafStripeStyle.RenderDataCache*/ newCache = demo.yfiles.graph.tableeditor.style.AlternatingLeafStripeStyle.createRenderDataCache(ctx, descriptor, stripe, stripeInsets.clone());
      ...
      '$static': {
        'RenderDataCache': new yfiles.ClassDefinition(function() {
          return {
            ...
            '$Equals$0': function(/*demo.yfiles.graph.tableeditor.style.AlternatingLeafStripeStyle.RenderDataCache*/ other) {
            ...
            'equals': function(/*yfiles.lang.Object*/ obj) {
              ...
              if (yfiles.lang.getType(obj) !== demo.yfiles.graph.tableeditor.style.AlternatingLeafStripeStyle.RenderDataCache.$class) {
                return false;
              }
              return this.$Equals$0(/*(demo.yfiles.graph.tableeditor.style.AlternatingLeafStripeStyle.RenderDataCache)*/obj);
            },
            '$$init$0': function() {
        ...
        'createRenderDataCache': function(/*yworks.canvas.drawing.IRenderContext*/ renderContext, /*demo.yfiles.graph.tableeditor.style.StripeDescriptor*/ descriptor, /*yworks.yfiles.ui.model.IStripe*/ stripe, /*yworks.canvas.geometry.structs.InsetsD*/ insets) {
          var /*demo.yfiles.graph.tableeditor.style.AlternatingLeafStripeStyle.RenderDataCache*/ newInstance = new demo.yfiles.graph.tableeditor.style.AlternatingLeafStripeStyle.RenderDataCache();
          {
