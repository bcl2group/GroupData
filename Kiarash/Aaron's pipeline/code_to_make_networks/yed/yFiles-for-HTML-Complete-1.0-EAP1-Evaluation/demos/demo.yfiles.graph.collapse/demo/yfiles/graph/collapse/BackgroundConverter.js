...
yfiles.module("demo.yfiles.graph.collapse", function(exports) {
  ...
  /*public*/ exports.BackgroundConverter = new yfiles.ClassDefinition(function() {
    return {
      ...
      'convert': function(/*yfiles.lang.Object*/ value, /*yfiles.lang.Object*/ parameter) {
        if (yfiles.lang.Boolean.$class.isInstance(value)) {
          return /*(yfiles.lang.Boolean)*/value ? "url(#innerGradient_checked)" : "url(#innerGradient_unchecked)";
        }
        return "#FFF";
      },
