...
yfiles.module("orgchart.support", function(exports) {
  ...
  /*private*/ exports.BackgroundConverter = new yfiles.ClassDefinition(function() {
    return {
      ...
      'convert': function(/*yfiles.lang.Object*/ value, /*yfiles.lang.Object*/ parameter) {
        if (yfiles.lang.Boolean.$class.isInstance(value)) {
          return /*(yfiles.lang.Boolean)*/value ? "url(#background_gradient_focused)" : "url(#background_gradient)";
        }
        return "";
      },
